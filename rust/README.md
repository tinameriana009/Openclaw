...
- Recursive traces now capture novelty/progress signals per child step, and retrieval requests now carry lightweight planner metadata (strategy / rationale / anchor terms) to make follow-up search behavior easier to inspect. This is still heuristic guidance rather than a full planner or formal verifier.
